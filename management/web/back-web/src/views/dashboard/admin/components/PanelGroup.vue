    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('messages')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="analyzeCount.commentCount" :duration="3000" class="card-panel-num" />
        </div>
      </div>
    </el-col>
  </el-row>
...
import {analyzeCount} from "../../../../api/analyze";
...
export default {
  ...
  methods: {
    fetchData() {
      analyzeCount().then(response => {
        this.analyzeCount = response.data;
      })
    },
